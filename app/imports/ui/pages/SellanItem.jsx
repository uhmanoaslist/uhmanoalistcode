...
class SellanItem extends React.Component {
  ...
  submit(data) {
    const { name, price, quantity, image, description } = data;
    const seller = Meteor.user().username;
    Listings.insert({ name, price, quantity, image, description, seller }, this.insertCallback);
  }
  ...
  render() {
    return (
        <Grid container centered>
          <Grid.Column>
            <Header as="h2" textAlign="center">Sell an Item</Header>
