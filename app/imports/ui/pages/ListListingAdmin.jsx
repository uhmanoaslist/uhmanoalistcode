...
import ListingItemAdmin from '/imports/ui/components/ListingItemAdmin';
    ...
    return (
        <Container>
          ...
          <Table celled>
            ...
            <Table.Body>
              {this.props.listings.map((listing) => <ListingItemAdmin key={listing._id} listing={listing} />)}
            </Table.Body>
          </Table>
        </Container>
    );
...
export default withTracker(() => {
  ...
  const subscription = Meteor.subscribe('ListingAdmin');
  return {
